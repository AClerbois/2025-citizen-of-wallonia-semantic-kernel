...
//IChatCompletionService chatService = new MistralAIChatCompletionService("mistral-small-mini", Environment.GetEnvironmentVariable("AI:Mistral:Key")); Console.WriteLine("Configuration : Mistral - mistral-small-mini");
 IChatCompletionService chatService = new AzureOpenAIChatCompletionService("gpt-4.5-preview", "https://aihubcitizenof7688094729.openai.azure.com/", Environment.GetEnvironmentVariable("AI:AzureOpenAI:Key")); Console.WriteLine("Configuration : Azure OpenAI - gpt-4.5-preview");
//IChatCompletionService chatService = new OllamaChatCompletionService("llama2-uncensored:7b", new Uri("http://127.0.0.1:11434/")); Console.WriteLine("Configuration : Ollama - llama2-uncensored:7b");
